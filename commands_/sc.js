    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            if (Number.isInteger(parseInt(input))) {
                ...
                if (getSeriesName[0].length == 0) return interaction.reply({ content: 'Nome ou ID incorreto.' });
                ...
                if (getChars[0].length == 0) return interaction.reply({ content: 'Nome ou ID incorreto.' });
